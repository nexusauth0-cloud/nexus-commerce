...
export function TrendingCategories() {
  return (
    <section className="relative overflow-hidden py-24" aria-labelledby="categories-heading">
      <div className="container-wide">
        ...
        >
          <h2 id="categories-heading" className="font-sans text-4xl font-bold tracking-tight text-white md:text-5xl">
            Trending Categories
          </h2>
